  ...
  return (
    <Card title="Whitelist Conditions">
      <Flex style={{ marginBottom: 8 }}>
        <Box p={1}>
          <Typography>
            The app will track and send to GitStart any activity that matches the following
            conditions:
          </Typography>
        </Box>
      </Flex>
      ...
      <Flex style={{ marginBottom: 8 }}>
        <Box p={1}>
          <Typography>
            <strong>Note</strong>: Any activity that neither matches the Blacklist conditions nor
            Whitelist conditions is still tracked but not sent to GitStart.
          </Typography>
          <Typography>
            <strong>Note 2</strong>: Adding a new condition will affect both{' '}
            <strong>new and old</strong> activities. Old activities will be sent after adding a new
            condition.
          </Typography>
        </Box>
      </Flex>
